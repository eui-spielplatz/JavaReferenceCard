...
\begin{struktogramm}(60,29)
	\while[4]{Solange Bedingung1}
		\assign{Anweisung}
		\ifthenelse{2}{2}{Bedingung2}{ja}{nein}
			\assign{Tu dies}
			\change
			\assign{Tu das}
		\ifend
...
\lstinputlisting{Exceptions.java}
\end{fancybox}

\begin{fancybox}{pagepurple}{borderpurple}
\fancyheader{Eigene Exception}
\lstinputlisting{CustomException.java}
...
\lstinputlisting{ExceptionMain.java}
\end{fancybox}
